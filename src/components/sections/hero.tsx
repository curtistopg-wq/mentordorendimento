  ...
  return (
    <section id="hero" data-clarity-region="hero" className="relative min-h-[70vh] lg:min-h-[85vh] flex items-end pt-20 lg:pt-32">
      ...
      <div className="container-custom relative z-10 pb-16">
        {/* Content Card */}
        <div className="max-w-xl bg-white/95 backdrop-blur-sm p-8 md:p-10 animate-hero-slide-in">
          {/* Badge */}
          ...
          {/* Main Heading */}
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-display font-normal text-primary-800 mb-6 leading-tight animate-hero-fade-up hero-delay-300">
            {t('title')}
          </h1>

          {/* Subtitle */}
          <p className="text-base text-primary-600 leading-relaxed animate-hero-fade-up hero-delay-400">
            {t('subtitleStart')}{' '}
          ...
          {/* CTA Button */}
          <div className="mt-6 animate-hero-fade-up hero-delay-500">
            <button
              onClick={open}
          ...
          {/* Social Proof */}
          <div className="mt-6 flex items-center gap-3 animate-hero-fade-up hero-delay-600">
